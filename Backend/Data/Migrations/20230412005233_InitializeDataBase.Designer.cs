...
namespace Data.Migrations
{
    ...
    [Migration("20230412005233_InitializeDataBase")]
            ...
            modelBuilder.Entity("Domain.Model.UserHasCards", b =>
                {
                    ...
                    b.HasOne("Domain.Model.GameHasUser", "Game")
                        .WithOne("UserHasCards")
                        .HasForeignKey("Domain.Model.UserHasCards", "GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
